...
if [ -f /mnt/us/extensions/kindle_copyparty/kindle_copyparty.sh ] && [ -f /etc/upstart/kindle_copyparty.conf ] && [ -f /mnt/us/extensions/kindle_copyparty/kindle_copyparty.ext3 ] ; then
    /mnt/us/extensions/kterm/bin/kterm -e "cd /mnt/us/extensions/kindle_copyparty && sh /mnt/us/extensions/kindle_copyparty/kindle_copyparty.sh; chroot /tmp/kindle_copyparty /bin/bash -c '/start_kindle_copyparty.sh'" -k 1 -o U -s 7
else
